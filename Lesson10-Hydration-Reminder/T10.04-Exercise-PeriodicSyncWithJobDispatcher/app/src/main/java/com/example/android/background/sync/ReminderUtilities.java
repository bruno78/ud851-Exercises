...
public class ReminderUtilities {
    ...
    private static final int REMINDER_INTERNAL_SECONDS = (int)(TimeUnit.MINUTES.toSeconds(REMINDER_INTERVAL_MINUTES));
    private static final int SYNC_FLEXTIME_SECONDS = REMINDER_INTERNAL_SECONDS;
    ...
    public static void scheduleChargingReminder(@NonNull final Context context) {
        ...
        Job constraintReminderJob = dispatcher.newJobBuilder()
                ...
                .setTrigger(Trigger.executionWindow(
                        REMINDER_INTERNAL_SECONDS,
                        REMINDER_INTERNAL_SECONDS + SYNC_FLEXTIME_SECONDS ))
