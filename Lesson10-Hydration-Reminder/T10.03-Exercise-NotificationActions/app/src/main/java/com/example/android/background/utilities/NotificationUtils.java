...
public class NotificationUtils {
    ...
    private static final int ACTION_IGNORE_PENDING_INTENT_ID = 4567;

    private static final int ACTION_DRINK_WATER_ID = 4568;
    ...
    public static void remindUserBecauseCharging(Context context) {
        ...
        NotificationCompat.Builder notificationBuilder = new NotificationCompat.Builder(context,WATER_REMINDER_NOTIFICATION_CHANNEL_ID)
                ...
                .addAction(drinkwWaterAction(context))
    ...
    private static NotificationCompat.Action ignoreReminderAction(Context context) {
        ...
        PendingIntent ignorePendingWaterService = PendingIntent.getService(
                context,
    ...
    private static NotificationCompat.Action drinkwWaterAction(Context context) {
