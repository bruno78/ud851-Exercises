...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String LIFYCYCLE_CALLBACKS_TEXT_KEY = "callback";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null && savedInstanceState.containsKey(LIFYCYCLE_CALLBACKS_TEXT_KEY)) {
            String lifecycleDisplayText = (String) savedInstanceState.get(LIFYCYCLE_CALLBACKS_TEXT_KEY);
            mLifecycleDisplay.setText(lifecycleDisplayText);
        }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        String lifecycleTextDisplay = mLifecycleDisplay.getText().toString();
        outState.putString(LIFYCYCLE_CALLBACKS_TEXT_KEY, lifecycleTextDisplay);
    }
