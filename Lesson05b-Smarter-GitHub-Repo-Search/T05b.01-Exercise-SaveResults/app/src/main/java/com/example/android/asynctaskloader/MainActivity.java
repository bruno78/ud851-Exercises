...
public class MainActivity extends AppCompatActivity {
    ...
    private static String URL_QUERY = "query";
    // COMPLETED (2) Create a static final key to store the search's raw JSON
    private static String JSON_SEARCH_RESULTS = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            mSearchResultsTextView.setText(savedInstanceState.getString(JSON_SEARCH_RESULTS));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(URL_QUERY, UrlString);
        ...
        outState.putString(JSON_SEARCH_RESULTS, JSONString);
    }
}