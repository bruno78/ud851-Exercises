...
public class MainActivity extends AppCompatActivity {
    ...
    public void shareText(String text) {
        ...
        Intent sharingText = ShareCompat.IntentBuilder.from(MainActivity.this)
                .setChooserTitle(title)
                .setType(mimeType)
                .setText(text)
                .getIntent();
        if(sharingText.resolveActivity(getPackageManager()) != null) startActivity(sharingText);
    }
}