...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickOpenAddressButton(View v) {
        ...
        String addressLocation = "1600 Amphitheatre Parkway, CA";
        // COMPELTED (6) Use Uri.Builder with the appropriate scheme and query to form the Uri for the address
        Uri uriAddress = new Uri.Builder()
                .scheme("geo")
                .path("0,0")
                .query(addressLocation)
                .build();
    ...
    public void showMap(Uri geoLocation) {
        ...
        Intent requestMap = new Intent(Intent.ACTION_VIEW);
        // COMPLETED (3) Set the data of the Intent to the Uri passed into this method
        requestMap.setData(geoLocation);
        // COMPLETED (4) Verify that this Intent can be launched and then call startActivity
        if(requestMap.resolveActivity(getPackageManager()) != null) startActivity(requestMap);
    }
